...
_HAIKU_BUILD_DECLARE_FUNCTION(ssize_t, readlink,(const char *path, char *buffer, size_t bufferSize))
_HAIKU_BUILD_DECLARE_FUNCTION(ssize_t, readlinkat, (int fd, const char *path, char *buffer,
					size_t bufferSize))
...
_HAIKU_BUILD_DECLARE_FUNCTION(ssize_t, read, (int fd, void *buffer, size_t count))
_HAIKU_BUILD_DECLARE_FUNCTION(ssize_t, read_pos, (int fd, off_t pos, void *buffer, size_t count))
_HAIKU_BUILD_DECLARE_FUNCTION(ssize_t, pread, (int fd, void *buffer, size_t count, off_t pos))
_HAIKU_BUILD_DECLARE_FUNCTION(ssize_t, write, (int fd, const void *buffer, size_t count))
_HAIKU_BUILD_DECLARE_FUNCTION(ssize_t, write_pos, (int fd, off_t pos, const void *buffer,size_t count))
_HAIKU_BUILD_DECLARE_FUNCTION(ssize_t, pwrite, (int fd, const void *buffer, size_t count, off_t pos))
...
_HAIKU_BUILD_DECLARE_FUNCTION(int, chown, (const char *path, uid_t owner, gid_t group))
_HAIKU_BUILD_DECLARE_FUNCTION(int, fchown, (int fd, uid_t owner, gid_t group))
_HAIKU_BUILD_DECLARE_FUNCTION(int, lchown, (const char *path, uid_t owner, gid_t group))
_HAIKU_BUILD_DECLARE_FUNCTION(int, fchownat, (int fd, const char *path, uid_t owner, gid_t group,
					int flag))

_HAIKU_BUILD_DECLARE_FUNCTION(int, mknod, (const char *name, mode_t mode, dev_t dev))
_HAIKU_BUILD_DECLARE_FUNCTION(int, mknodat, (int fd, const char *name, mode_t mode, dev_t dev))
...
_HAIKU_BUILD_DECLARE_FUNCTION(size_t, confstr, (int name, char *buf, size_t len))
...
_HAIKU_BUILD_DECLARE_FUNCTION(useconds_t, ualarm, (useconds_t microSeconds, useconds_t interval))
...
_HAIKU_BUILD_DECLARE_FUNCTION(int, getgrouplist, (const char* user, gid_t baseGroup,
					gid_t* groupList, int* groupCount))
_HAIKU_BUILD_DECLARE_FUNCTION(int, getgroups, (int groupCount, gid_t groupList[]))
_HAIKU_BUILD_DECLARE_FUNCTION(int, initgroups, (const char* user, gid_t baseGroup))
_HAIKU_BUILD_DECLARE_FUNCTION(int, setgroups, (int groupCount, const gid_t* groupList))

_HAIKU_BUILD_DECLARE_FUNCTION(char*, getlogin, (void))
_HAIKU_BUILD_DECLARE_FUNCTION(int, getlogin_r, (char *name, size_t nameSize))

/* host name */
_HAIKU_BUILD_DECLARE_FUNCTION(int, sethostname, (const char *hostName, size_t nameSize))
_HAIKU_BUILD_DECLARE_FUNCTION(int, gethostname, (char *hostName, size_t nameSize))

/* tty */
_HAIKU_BUILD_DECLARE_FUNCTION(int, isatty, (int fd))
_HAIKU_BUILD_DECLARE_FUNCTION(char*, ttyname, (int fd))
_HAIKU_BUILD_DECLARE_FUNCTION(int, ttyname_r, (int fd, char *buffer, size_t bufferSize))
...
_HAIKU_BUILD_DECLARE_FUNCTION(void, swab, (const void *src, void *dest, ssize_t nbytes))
