...
typedef	__haiku_build_haiku_std_uint8	_HAIKU_BUILD_IDENTIFIER(uint8_t);

typedef	__haiku_build_haiku_std_int16	_HAIKU_BUILD_IDENTIFIER(int16_t);
typedef	__haiku_build_haiku_std_uint16	_HAIKU_BUILD_IDENTIFIER(uint16_t);

typedef	__haiku_build_haiku_std_int32	_HAIKU_BUILD_IDENTIFIER(int32_t);
typedef	__haiku_build_haiku_std_uint32	_HAIKU_BUILD_IDENTIFIER(uint32_t);

typedef	__haiku_build_haiku_std_int64	_HAIKU_BUILD_IDENTIFIER(int64_t);
typedef	__haiku_build_haiku_std_uint64	_HAIKU_BUILD_IDENTIFIER(uint64_t);
...
typedef	__haiku_build_haiku_saddr_t		_HAIKU_BUILD_IDENTIFIER(intptr_t);
typedef	__haiku_build_haiku_addr_t		_HAIKU_BUILD_IDENTIFIER(uintptr_t);

/* Greatest-width integer types */
typedef	_haiku_build_int64_t			_HAIKU_BUILD_IDENTIFIER(intmax_t);
typedef	_haiku_build_uint64_t			_HAIKU_BUILD_IDENTIFIER(uintmax_t);
