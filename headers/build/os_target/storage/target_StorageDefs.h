...
#define _HAIKU_BUILD_B_MIME_TYPE_LENGTH		(B_ATTR_NAME_LENGTH - 15)
...
#define _HAIKU_BUILD_B_READ_WRITE		O_RDWR   	// read and write

#define	_HAIKU_BUILD_B_FAIL_IF_EXISTS	O_EXCL		// exclusive create
#define _HAIKU_BUILD_B_CREATE_FILE		O_CREAT		// create the file
#define _HAIKU_BUILD_B_ERASE_FILE		O_TRUNC		// erase the file's data
#define _HAIKU_BUILD_B_OPEN_AT_END	   	O_APPEND	// point to the end of the data
