...
/* implied properties:
   __HAIKU_BUILD_HAIKU_ARCH_{32,64}_BIT		- defined to 1 on 32/64 bit architectures, i.e.
   ...
   __HAIKU_BUILD_HAIKU_ARCH_PHYSICAL_{32,64}_BIT - defined to 1 on architectures using 64
   								  bit physical addresses
...
#	define __HAIKU_BUILD_HAIKU_ARCH_PHYSICAL_BITS	__HAIKU_BUILD_HAIKU_ARCH_BITS
#endif
...
#		define __HAIKU_ARCH_PHYSICAL_64_BIT	__HAIKU_BUILD_HAIKU_ARCH_PHYSICAL_64_BIT
#	endif

#	ifdef __HAIKU_BUILD_HAIKU_ARCH_LITTLE_ENDIAN
#		define __HAIKU_ARCH_LITTLE_ENDIAN	__HAIKU_BUILD_HAIKU_ARCH_LITTLE_ENDIAN
#	endif
...
#	define __HAIKU_ARCH_HEADER(header)		\
		__HAIKU_BUILD_HAIKU_ARCH_HEADER(header)
